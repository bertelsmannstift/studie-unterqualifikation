...
reg lwage c.tenure##c.tenure c.expft##c.expft i.ftime i.married yeduc i.unjan i.befr i.bula i.year i.isco1 dchild i.fsize ///
...
i.bula i.year ///
[weight=phrf] if jobreq == `x' & sex == `n', cluster(persnr)
}
}
